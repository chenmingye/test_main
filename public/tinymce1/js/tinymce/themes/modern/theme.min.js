!(function() {
  ...
  var e,
    ...
    xe = function(t, e, n) {
      ...
      if (
        ...
        var l = y.translate(['Powered by {0}', '<span></span>']),
  ...
  var Te = function() {
    ...
    Se = {
      ...
      moveTo: function(e, t) {
        ...
        return (
          s && Re(s) && !Ee(n) && ((e -= s.scrollLeft), (t -= s.scrollTop)),
          s && ((e += 1), (t += 1)),
    ...
    Ke = Me.extend({
      ...
      set: function(t, n) {
        var i,
          ...
          o = this.data[t];
        if (
          (n instanceof Xe && (n = n.create(this, t)), 'object' == typeof t)
        ) {
  ...
  function Lt(o) {
    ...
    return {
      open: function(e, t) {
        var n,
          i = w.extend(e, { maxWidth: ((n = s(o)), Ce.getSize(n).width) }),
          r = new Bt(i);
        return (
          0 < (r.args = i).timeout &&
    ...
    init: function(e) {
      ...
      n._super(e),
        ...
        n.on('click', function(e) {
          ...
          (Ce.hasClass(e.target, t) || Ce.hasClass(e.target.parentNode, t)) &&
            n.close();
        }),
  ...
  var Yt = Vt.extend({
    ...
    sn = Wt.extend({
      ...
      postRender: function() {
        ...
        function c(e, t) {
          var n = (360 - e.h) / 360;
          Ce.css(r, { top: 100 * n + '%' }),
            t || Ce.css(s, { left: e.s + '%', top: 100 - e.v + '%' }),
    ...
    Jn = function(e) {
      return (
        (e.nodeType !== qn && e.nodeType !== jn) || 0 === e.childElementCount
      );
    },
    Gn = {
      all: function(e, t) {
      ...
      recalc: function(e) {
        ...
        if (
          ...
          for (b = d / c, t = 0, n = L.length; t < n; t++)
            (v = (m = (h = L[t]).layoutRect())[E]) < (p = m[C] + m.flex * b)
              ? ((d -= m[E] - m[C]),
                (c -= m.flex),
                (m.flex = 0),
                (m.maxFlexSize = v))
          ...
          for (
            b = d / c,
              ...
              0 === c &&
                ('end' === l
                  ? (x = d + o[k])
                  : 'center' === l
                  ? (x = Math.round(r[T] / 2 - (r[T] - d) / 2) + o[k]) < 0 &&
                    (x = o[k])
                  : 'justify' === l &&
            ...
            (p = (m = (h = i[t]).layoutRect()).maxFlexSize || m[C]),
              'center' === a
                ? (y[M] = Math.round(r[N] / 2 - m[P] / 2))
                : 'stretch' === a
                ? ((y[P] = I(m[D] || 0, r[N] - o[W] - o[O])), (y[M] = o[W]))
    ...
    Mi = function(i) {
      var t = ['alignleft', 'aligncenter', 'alignright', 'alignjustify'],
        r = 'alignleft',
        e = [
          { text: 'Left', icon: 'alignleft', onclick: Ti(i, 'alignleft') },
          {
            text: 'Center',
            icon: 'aligncenter',
          ...
          l.on('init nodeChange', function(e) {
            var t,
              ...
              s =
                ...
                w.each(t, function(e) {
                  i ||
                    Ni(e.value).toLowerCase() !== Ni(r).toLowerCase() ||
                    (i = e.value);
                }),
                i);
      ...
      return (
        e.items().each(function(e) {
          e.menu && e.visible(0 < zi(n, e.menu)),
            !e.menu && e.settings.menu && e.visible(0 < Ii(n, e.settings.menu));
        ...
        u =
          ...
          }),
          {
            ...
            itemDefaults: {
              ...
              onclick: function() {
                this.settings.format && Ti(i, this.settings.format)(),
    ...
    tr = qt.extend({
      recalc: function(e) {
        ...
        for (k = o.innerW - p.left - p.right, d = _ = 0; d < i; d++)
          (_ += S[d] + (0 < d ? b : 0)), (k -= (0 < d ? b : 0) + S[d]);
        for (T = o.innerH - p.top - p.bottom, f = C = 0; f < n; f++)
          (C += M[f] + (0 < f ? y : 0)), (T -= (0 < f ? y : 0) + M[f]);
        if (
          ((_ += p.left + p.right),
          (C += p.top + p.bottom),
          ...
          o.autoResize &&
            ...
            (l.contentH = l.minH - o.deltaH)),
            (N = 'start' === t.packV ? 0 : 0 < T ? Math.floor(T / n) : 0);
          var P = 0,
            D = t.flexWidths;
    ...
    ar = jt.extend({
      ...
      renderHtml: function() {
        ...
        return (
          ...
          t.aria('role', t.parent() instanceof sr ? 'menuitem' : 'button'),
          '<div id="' +
            n +
            '" class="' +
            t.classes +
          ...
          (m._dragHelper = new ft(m._id, {
            ...
            start: function(e) {
              (u = e[n]),
                ...
                (d = (m.layoutRect()[o] || 100) - Ce.getSize(l)[r]),
    ...
    xr = ar.extend({
      ...
      repaint: function() {
        ...
        return (
          ...
          (e = n.firstChild),
          (t = n.lastChild),
          we(e).css({ width: i.w - Ce.getSize(t).width, height: i.h - 2 }),
