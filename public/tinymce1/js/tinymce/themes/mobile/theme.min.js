!(function() {
  ...
  var n,
    ...
    Fe = function(n) {
      return (
        (n.nodeType !== Ne && n.nodeType !== Be) || 0 === n.childElementCount
      );
    },
    Ve = {
      all: function(n, e) {
    ...
    Hr = function(o, i, u) {
      ...
      return (
        ...
        (n.toFunctionAnnotation = function() {
          return { name: e, parameters: Ar(c.slice(0, 1).concat(c.slice(3))) };
        }),
        n
      );
    },
  ...
  var Co = function(n, e, t) {
            ...
            ? ((r = []),
              {
                ...
                write: function() {
                  hn(['mousemove', 'mouseover', 'mouseout', ne()], n) ||
                    console.log(n, {
                      event: n,
                      target: e.dom(),
    ...
    mi = E(ii),
    gi = [
      ar('channels', Wt(at.value, Pt([si('onReceive'), mr('schema', or())]))),
    ],
    ...
    Ti = Object.freeze({ onLoad: xi, toggle: hi, isOn: wi, on: bi, off: yi }),
    Si = Object.freeze({
    ...
    Bi = Object.freeze({
      exhibit: function(n, e) {
        return e.ignore() ? Nr({}) : Nr({ attributes: { tabindex: '-1' } });
      },
      events: function(t) {
        return br([
          wr(Gn(), function(n, e) {
  ...
  var $i,
    ...
    Su = function(e, n, t) {
      ...
      return (0 < r.length ? B.some(r[r.length - 1]) : B.none()).bind(function(
        n,
      ) {
        return e
          .getSystem()
            ...
            function(o) {
              i[o.pname()] = vc(!0, function(e, n, t) {
                ...
                return yn(r, function(n) {
                  return o
                    .factory()
                    .sketch(C(o.defaults()(e, n), n, o.overrides()(e, n)));
                });
              });
            },
          );
      ...
      factory: function(n) {
        ...
        return {
          ...
          behaviours: C(
            qr([
              Vi.config({}),
              uc.config({ mode: 'execution', useSpace: !0, useEnter: !0 }),
            ]),
      ...
      factory: function(c, n, e, t) {
        var s = c.max() - c.min(),
          ...
          r = function(n, e) {
            var t = c.value().get(),
              r = o(n);
            return t !== e || _i.getRaw(r.element(), 'left').isNone()
              ? (c.value().set(e), u(n), c.onChange()(n, r, e), B.some(!0))
              : B.none();
          },
          a = Ks
            ? [
    ...
    Zs = function(n) {
      return [
        ...
        Js.sketch({
          ...
          components: [
            Js.parts()['left-edge'](
              gs('<div class="${prefix}-hue-slider-black"></div>'),
            ),
            Js.parts().spectrum({
              dom: ms(
                '<div class="${prefix}-slider-gradient-container"></div>',
              ),
              components: [gs('<div class="${prefix}-slider-gradient"></div>')],
              behaviours: qr([
                ki.config({ toggleClass: Mi.resolve('thumb-active') }),
              ]),
            }),
            Js.parts()['right-edge'](
              gs('<div class="${prefix}-hue-slider-white"></div>'),
            ),
            Js.parts().thumb({
    ...
    tf = function(n) {
      ...
      return Js.sketch({
        ...
        components: [
          Js.parts().spectrum({
            dom: ms('<div class="${prefix}-slider-size-container"></div>'),
            components: [gs('<div class="${prefix}-slider-size-line"></div>')],
          }),
          Js.parts().thumb({
            dom: ms('<div class="${prefix}-slider-thumb"></div>'),
            behaviours: qr([
  ...
  var Sf,
      ...
      return {
        ...
        value: {
          ...
          me:
            ((t = n),
            (r = br(e)),
            Xr({ fields: [ur('enabled')], name: t, active: { events: E(r) } })),
          configAsRaw: E({}),
          initialConfig: {},
          state: $r,
        },
    ...
    Yf = as({
      ...
      factory: function(n) {
        return {
          uid: n.uid(),
          dom: C({ tag: 'div', attributes: { role: 'presentation' } }, n.dom()),
          components: n.components(),
    ...
    el = Object.freeze({
      exhibit: function(n, e) {
        return Nr({ attributes: Dt([{ key: e.tabAttr(), value: 'true' }]) });
      },
    }),
      ...
      return {
        ...
        spec: Yf.sketch({
          ...
          containerBehaviours: qr([
            ki.config({ toggleClass: Mi.resolve('input-container-empty') }),
            qf.config({
              find: function(n) {
            ...
            ((i = []),
            {
              field: function(n, e) {
                return (
                  ...
                  (r = yl(n)),
                  (o = e),
                  { uiType: pc(), owner: t, name: r, config: o, validated: {} }
                );
                var t, r, o;
              },
              record: function() {
    ...
    El = function(n) {
      var r = 'navigateEvent',
        ...
        i = function(n, o) {
          ...
          ou(n.element(), '.' + Mi.resolve('serialised-dialog-chain')).each(
            function(r) {
        ...
        c = sf(
          xl(function(t) {
            return {
              dom: ms('<div class="${prefix}-serialised-dialog"></div>'),
              components: [
                Yf.sketch({
                  dom: ms(
    ...
    $l = function(n, i) {
      var e = j(n, function(r, o) {
        return (1 === r.length ? at.value(r[0].handler()) : Wl(r, i, o)).map(
          function(n) {
            var e = _l(n),
              t =
                1 < r.length
        ...
        (g = ed({
          ...
          config: function(n) {
            ...
            return (w(e[n.name()])
              ...
              : function() {
                  throw new Error(
                    'Could not find ' + n.name() + ' in ' + Bt(r, null, 2),
                  );
                })();
          },
          ...
          behaviours: C(
            qr([
              n.toggling().fold(ki.revoke, function(n) {
                return ki.config(C({ aria: { mode: 'checked' } }, n));
              }),
              Vi.config({
              ...
              uc.config({ mode: 'execution' }),
              Ws.config({ store: { mode: 'memory', initialValue: n.data() } }),
            ]),
            n.itemBehaviours(),
          ),
          events: br([
    ...
    bd = [
      ...
      li('builder', function(t) {
        ...
        return C({
          ...
          behaviours: qr([
            Ws.config({ store: { mode: 'memory', initialValue: t.data() } }),
            Vi.config({
              onFocus: function(n) {
                dd(n);
              },
            ...
            uc.config({
              ...
              onEscape: function(n, e) {
                return Vi.isFocused(n) || t.autofocus()
                  ? (t.autofocus() && e.setSource(n.element()), B.none())
                  : (Vi.focus(n), B.some(!0));
              },
            }),
          ]),
        ...
        return C({
          ...
          behaviours: C(
            qr([
              ...
              Ws.config({ store: { mode: 'memory', initialValue: n.value() } }),
              qf.config({ find: B.some }),
    ...
    Id = as({
      ...
      factory: function(u, o) {
        var i = function(r, n) {
            ...
            return B.from(i[0])
              ...
              .map(function(n) {
                ...
                wn(e, function(n) {
                  ...
                  xe.inBody(n.element()) || Ed.append(r, cd(n)),
                  Xl(n.element(), [u.markers().backgroundMenu()]),
                  f(r, n);
            ...
            return a.expand(n).bind(function(n) {
              return (
                B.from(n[0])
                  .bind(a.lookupMenu)
                  .each(function(n) {
                    xe.inBody(n.element()) || Ed.append(e, cd(n)),
          ...
          n = function(t) {
            return function(e, n) {
              return iu(n.getSource(), '.' + u.markers().item()).bind(function(
                n,
              ) {
                return e
                  .getSystem()
              ...
              Nd(0, o, 0, e).each(function(n) {
                n.transition().each(function(n) {
                  r.propertyName === n.property() &&
                    (Hd(t, o, i, e.destination()), o.onTransition()(t, e));
                });
              });
            });
          }),
    ...
    Ld = [
      ...
      ar(
        ...
        Wt(
          ...
          Wt(
            at.value,
            Pt([dr('transition', [ur('property'), ur('transitionClass')])]),
          ),
        ),
      ),
    ],
              ...
              Wf('adhoc-scrollable-menu', [
                Cr(function(n, e) {
                  _i.set(n.element(), 'overflow-y', 'auto'),
                    _i.set(n.element(), '-webkit-overflow-scrolling', 'touch'),
                    _d.register(n.element());
                }),
                kr(function(n) {
                  _i.remove(n.element(), 'overflow-y'),
                    _i.remove(n.element(), '-webkit-overflow-scrolling'),
      ...
      var a = function(n) {
        ...
        s = function(n) {
          return yn(n, function(n) {
            if (Rt(n, 'items')) {
              var e = s(n.items);
              return C(C(n, { isSelected: E(!1), getPreview: E('') }), {
                items: e,
              });
            }
            return Rt(n, 'format')
              ? C((i = n), { isSelected: a(i.format), getPreview: c(i.format) })
              : ((r = bc((t = n).title)),
                (o = C(t, { format: r, isSelected: a(r), getPreview: c(r) })),
            ...
            return An(n, function(n) {
              return n.items !== undefined
                ? 0 < o(n.items).length
                  ? [n]
                  : []
                : !Rt(n, 'format') || e.formatter.canApply(n.format)
                ? [n]
                : [];
            });
          })(n)),
      ...
      return {
        ...
        link: p(B.none(), function() {
          return (
            (e = r),
            (t = o),
            hs.forToolbarStateAction(t, 'link', 'link', function() {
              var n = Dl(e, t);
    ...
    om = function(n, t) {
      ...
      return An(e, function(n) {
        var e =
          !Rt(r, n) && Rt(t, n) && t[n].isSupported() ? [t[n].sketch()] : [];
        return (r[n] = !0), e;
      });
    },
    im = function(m, g) {
    ...
    um = function(n, e, t, r, o) {
      var i = im(t, r);
      return n.dom().addEventListener(e, i, o), { unbind: l(am, n, e, i, o) };
    },
    am = function(n, e, t, r) {
      ...
      var e = fe.fromDom(u.document.body),
        t = lm(fe.fromDom(n), 'resize', function() {
          sg(n, e).each(function(i) {
            ...
            ((n = u),
            (e = og(n)),
            0 < e.length ? B.some(e[0]).map(cg) : B.none()).each(function(n) {
              var e,
                t,
                r,
                o =
    ...
    Og = function(n, e) {
      var t,
        ...
        a =
          ((t = e),
          (r = _i.get(t, 'background-color')) !== undefined && '' !== r
    ...
    Cg = function() {
      ...
      wn(n, function(n) {
        var e = ro.get(n, wg);
        'no-styles' !== e ? ro.set(n, 'style', e) : ro.remove(n, 'style'),
          ro.remove(n, wg);
      });
    },
    kg = function() {
    ...
    Eg = function(e, n) {
      ...
      return {
        ...
        exit: function() {
          t.restore(),
            n.show(),
            bo.remove(e.container, Mi.resolve('fullscreen-maximized')),
    ...
    Ag = function(n, e) {
      ...
      return Yf.sketch({
        ...
        components: [
          Yf.sketch({
            dom: ms('<div class="${prefix}-content-container"></div>'),
            components: [
              ss.sketch({
                dom: ms('<div class="${prefix}-content-tap-section"></div>'),
                components: [i.asSpec()],
                action: function(n) {
                  u.throttle();
                },
  ...
  function Ug() {
    var e = function(n) {
        ...
        return {
          ...
          tgroupBehaviours: qr([
            Wf(
              ...
              !0 === n.scrollable
                ? [
                    Er(function(n, e) {
                      _i.set(n.element(), 'overflow-x', 'auto'),
          ...
          components: [Yf.sketch({ components: [Hg.parts().items({})] })],
  ...
  var Pg = function(n, e) {
        ...
        return br([
          wr(J(), function(n, e) {
            e.event().raw().propertyName === t.dimension().property() &&
              (Kg(n, t),
              r.isExpanded() &&
                _i.remove(n.element(), t.dimension().property()),
    ...
    av = Xr({ fields: iv, name: 'sliding', active: ov, apis: rv, state: uv }),
    cv = function(e, t) {
      var r = ad(
          Yf.sketch({
      ...
      return f.fold(
        ...
        function(e) {
          ...
          return (
            Ll(t)(l),
            l.isStopped()
              ? (i.logEventStopped(r, e.element(), t.purpose()), mv.stopped())
              : l.isCut()
              ? (i.logEventCut(r, e.element(), t.purpose()), mv.complete())
              : $e.parent(e.element()).fold(
                  function() {
                    return (
                      i.logNoParent(r, e.element(), t.purpose()), mv.complete()
                    );
                  },
                  function(n) {
                    return (
        ...
        e = function(n) {
          n.connect(i),
            be.isText(n.element()) ||
              (o.register(n),
              wn(n.components(), e),
              i.triggerEvent(ne(), n.element(), { target: E(n.element()) }));
        },
        u = function(n) {
          be.isText(n.element()) || (wn(n.components(), u), o.unregister(n)),
            n.disconnect();
        },
        a = function(n) {
          et(t, n);
  ...
  function kv(n) {
    var e = ad(
      Yf.sketch({
        ...
        containerBehaviours: qr([To.config({ alpha: Ov(), omega: Cv() })]),
      }),
    );
    return Sv(e);
  }
  var Ev = function(n, e) {
            ...
            gp(n, r.pageYOffset).get(function() {
              ...
              B.from(n[0]).bind(function(n) {
                ...
                return e > r.innerHeight + 5 || e < -5
                  ? B.some({ top: E(e), bottom: E(e + n.height()) })
                  : B.none();
              })).each(function(n) {
      ...
      return {
        enter: function() {
          ...
          yg.getActiveApi(r.editor).each(function(n) {
            i.set({
              ...
              u.set({ exclusives: Lg.exclusive(t, '.' + _d.scrollable()) }),
              bo.add(r.container, Mi.resolve('fullscreen-maximized')),
              Og(r.container, n.body()),
              o.maximize(),
              _i.set(r.socket, 'overflow', 'scroll'),
              _i.set(r.socket, '-webkit-overflow-scrolling', 'touch'),
              Io(n.body());
            var e = De(
              [
                'cWin',
        ...
        exit: function() {
          o.restore(),
            ...
            u.clear(),
            bo.remove(r.container, Mi.resolve('fullscreen-maximized')),
            Cg(),
    ...
    xp = function(n, e, t) {
      n.system().broadcastOn([jo.formatChanged()], { command: e, state: t });
    },
    Tp = function(r, n) {
      ...
      renderUI: function(n) {
        ...
        var t,
          ...
          b = Wn.detect().os.isAndroid()
            ? ((s = p),
              (f = kv({ classes: [Mi.resolve('android-container')] })),
              (l = Ug()),
              (d = Tl()),
              (m = Wg(d)),
              (g = $g()),
          ...
          C.on('init', function() {
            b.init({
              ...
              toolstrip: fe.fromDom(
                C.editorContainer.querySelector('.' + Mi.resolve('toolstrip')),
              ),
              toolbar: fe.fromDom(
                C.editorContainer.querySelector('.' + Mi.resolve('toolbar')),
              ),
              dropup: b.dropup(),
              alloy: b.system(),
              translate: k,
