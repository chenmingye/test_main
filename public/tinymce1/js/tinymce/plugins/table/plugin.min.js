!(function() {
  ...
  var e,
    ...
    me = function(e) {
      return (
        (e.nodeType !== se && e.nodeType !== de) || 0 === e.childElementCount
      );
    },
    ge = {
      all: function(e, t) {
      ...
      generate: function(e) {
        ...
        k(e, function(e, c) {
          ...
          k(e.cells(), function(e, t) {
            ...
            for (
              var r = ae.extended(e.element(), e.rowspan(), e.colspan(), c, n),
                o = 0;
              o < e.colspan();
              o++
            )
    ...
    pn =
      ...
      (Ot = Xe.detect().browser),
      {
        get: function(e) {
          if (!Nt(e))
            throw new Error(
              'Can only get ' + Dt + ' value of a ' + Dt + ' node',
            );
          return At(e).getOr('');
        },
        getOption: (At =
        ...
        set: function(e, t) {
          if (!Nt(e))
            throw new Error(
              'Can only set raw ' + Dt + ' value of a ' + Dt + ' node',
            );
          e.dom().nodeValue = t;
        },
      }),
                    ...
                    .map(function(e) {
                      ...
                      return I(
                        ...
                        function(e, t) {
                          var n = mn(t);
                          return (
                            bt.remove(n, 'contenteditable'), rn.append(e, n), n
                          );
                        },
                        o,
                      );
    ...
    return {
      ...
      property: C({
        ...
        isBoundary: function(e) {
          return (
            !!mt.isElement(e) && ('body' === mt.name(e) || E(kn, mt.name(e)))
          );
        },
        isEmptyTag: function(e) {
          return (
            !!mt.isElement(e) && E(['br', 'img', 'hr', 'input'], mt.name(e))
          );
        },
      }),
      eq: $e.eq,
  ...
  var In = X('left', 'right'),
    ...
    Wn = function(n, r, e) {
      return Bn(n, r, e).map(function(e) {
        var t = n.create().clone(r);
        return (
          n.insert().appendAll(t, e.after()), n.insert().after(r, t), In(r, t)
        );
      });
    },
    _n = function(i, e, u, a) {
      ...
      return $e.eq(a, c)
        ...
        : mr(a).bind(function(u) {
            return mr(c).bind(function(i) {
              if ($e.eq(u, i))
                return S.some(gr({ boxes: fr(u, a, c), start: a, finish: c }));
              if ($e.contains(u, i)) {
                var e =
                  0 < (t = St.ancestors(c, 'td,th', l(u))).length
                    ? t[t.length - 1]
                    : c;
                return S.some(
                  gr({ boxes: sr(u, a, u, c, i), start: a, finish: e }),
                );
              }
              if ($e.contains(i, u)) {
                var t,
                  n =
                    0 < (t = St.ancestors(a, 'td,th', l(i))).length
                      ? t[t.length - 1]
                      : a;
                return S.some(
                  gr({ boxes: sr(i, a, u, c, i), start: a, finish: n }),
                );
              }
              return Qn.ancestors(a, c)
                ...
                .bind(function(e) {
                  return Wt.closest(e, 'table', r).bind(function(e) {
                    ...
                    return S.some(
                      gr({ boxes: sr(e, a, u, c, i), start: o, finish: n }),
                    );
                  });
                });
            });
    ...
    Ar = function(n, e) {
      return Er.cata(
        ...
        function(t, e) {
          return 0 === t.length
            ? S.none()
            : xr(n, Tr.firstSelectedSelector(), Tr.lastSelectedSelector()).bind(
                function(e) {
                  return 1 < t.length
    ...
    kr = function(e, t) {
      ...
      return 0 < n.length &&
        j(n, function(e) {
          return (
            (bt.has(e, 'rowspan') && 1 < parseInt(bt.get(e, 'rowspan'), 10)) ||
            (bt.has(e, 'colspan') && 1 < parseInt(bt.get(e, 'colspan'), 10))
          );
        })
        ? S.some(n)
        : S.none();
    ...
    Wr = function(a, e, c, l) {
      a.on('BeforeGetContent', function(n) {
              ...
              n.preventDefault(),
                ...
                zt
                  ...
                  n.content = A(e, function(e) {
                    return (
                      (t = e), a.selection.serializer.serialize(t.dom(), {})
                    );
                    var t;
                  }).join('');
                });
        ...
        a.on('BeforeSetContent', function(u) {
          !0 === u.selection &&
            !0 === u.paste &&
            S.from(a.dom.getParent(a.selection.getStart(), 'th,td')).each(
              function(e) {
                var i = le.fromDom(e);
    ...
    Gr = function(e) {
      return Ur.browser.isIE() || Ur.browser.isEdge()
        ? ((n = Vr((t = e), 'padding-top', 0)),
          ...
          'border-box' === en.get(t, 'box-sizing') ? u : u - n - r - (o + i))
        : Vr(e, 'height', qr(e));
      var t, n, r, o, i, u;
    },
    Yr = /(\d+(\.\d+)?)(\w|%)*/,
  ...
  var To,
          ...
          return Rn.last(o)
            .bind(function(n) {
              ...
              return ot.parent(n).map(function(e) {
                return !0 === r ||
                  ((t = e),
                  'li' === mt.name(t) || Bt.ancestor(t, Uo).isSome()) ||
                  i(n) ||
                  (Ho(e) && !$e.eq(o, e))
                  ? []
                  : [le.fromTag('br')];
        ...
        var t = F(e.cells(), function(e, t) {
          if (!1 === u[r][t]) {
            ...
            return (
              ...
              [ae.detailnew(e.element(), n.rowspan(), n.colspan(), e.isNew())]
            );
          }
          return [];
        });
    ...
    Gi = function(t, n) {
      return zt.cell(n.element()).bind(function(e) {
        return ji(t, e).map(function(e) {
          return Xo(e, { generators: n.generators, clipboard: n.clipboard });
        });
      });
    },
    Yi = function(t, e) {
    ...
    nu = function(e, t, n) {
      ...
      var r = t.slice(e.row()),
        ...
        i = Zo.cellLength(n[0]),
        u = n.length;
      return Qi.value({ rowDelta: C(r.length - u), colDelta: C(o.length - i) });
    },
    ru = function(e, t) {
          ...
          for (
            ...
            for (var v = m; v < h; v++) {
              (i = t),
                ...
                1 < i.length &&
                  1 < Zo.cellLength(s) &&
                  ((0 < a && f(Zo.getCellElement(s, a - 1))) ||
                    (a < s.length - 1 && f(Zo.getCellElement(s, a + 1))) ||
                    (0 < u && f(Zo.getCellElement(i[u - 1], a))) ||
                    (u < i.length - 1 && f(Zo.getCellElement(i[u + 1], a)))) &&
                  uu(t, Zo.getCellElement(t[p], v), o, r.cell);
    ...
    fu = function(n, r, e, o, i) {
      var t = n.slice(0, r),
        ...
        a = Zo.mapCells(n[e], function(e, t) {
          return 0 < r &&
            r < n.length &&
            o(Zo.getCellElement(n[r - 1], t), Zo.getCellElement(n[r], t))
            ? Zo.getCell(n[r], t)
        ...
        var o = function(e, n) {
          return (
            ...
            Ia.each(e, function(e) {
              ...
              e.menu ? (t.menu = o(e.menu)) : ((t.value = e.value), r && r(t)),
                n.push(t);
            }),
            n
          );
    ...
    Qa = function(o, e, t) {
      var n,
        ...
        u = {
          styles: i,
          attributes:
            ((r = o), r.getParam('table_default_attributes', ba, 'object')),
  ...
  var ec = function(e, t, n) {
          ...
          t || (t = Qa(e, o.cols || 1, o.rows || 1)),
            (function(e, t, n) {
              ...
              n.style
                ...
                : (u = Ia.extend({}, o.parseStyle(o.getAttrib(t, 'style')), u)),
    ...
    oc = function(e) {
      var t = S.from(e.dom().documentElement)
        .map(le.fromDom)
        .getOr(e);
  ...
  var ac = {
    ...
    sc = function(e, t, n, r, o) {
      var i = fc(n, r);
      return e.dom().addEventListener(t, i, o), { unbind: R(dc, e, t, i, o) };
    },
    dc = function(e, t, n, r) {
  ...
  function Cc() {
    var n,
      ...
      e = {
        ...
        events: (n = ac.create({ drag: uc(['xDelta', 'yDelta']) })).registry,
      };
    return (
      ...
      t = (function(o, t, i) {
        ...
        var c = function(e, t) {
            d.trigger.startAdjust(),
              n.assign(e),
              bt.set(e, 'data-initial-' + t, parseInt(en.get(e, t), 10)),
              Ai.add(e, Sc),
          ...
          s = pc.bind(o.view(), 'mouseover', function(e) {
            ...
            Rc.closest(e.target(), 'table', f)
              ? (u =
                  'table' === mt.name(e.target())
                    ? S.some(e.target())
                    : Wt.ancestor(e.target(), 'table', f)).each(function(e) {
                  Li.refresh(o, e, i, t);
                })
  ...
  var Nc = function(e, t) {
    ...
    tl = function(t, e, n, r) {
      ...
      return Jo(i, function(e) {
        return (
          o.selectNode(e.dom()),
          Qc(o.getBoundingClientRect(), n, r) ? nl(t, e, n, r) : S.none()
        );
      });
    },
    nl = function(e, t, n, r) {
    ...
    Bl = function(e, t) {
      ...
      return ((n = r),
      0 === n.length ? S.none() : S.some(n[n.length - 1])).bind(function(e) {
      ...
      if (t.keyCode === Al.TAB) {
        ...
        if (e.collapsed) {
          ...
          zt.cell(a, u).each(function(e) {
            t.preventDefault(),
              (t.shiftKey ? Pl : kl)(n, u, e, r, o).each(function(e) {
  ...
  var Kl = function(n, e, r, t, o) {
    ...
    Ql = {
      ...
      moveBottomTo: function(e, t) {
        ...
        return $l({ left: e.left(), top: t - n, right: e.right(), bottom: t });
      },
      moveTopTo: function(e, t) {
        var n = e.bottom() - e.top();
        return $l({ left: e.left(), top: t, right: e.right(), bottom: t + n });
      },
      getTop: function(e) {
        return e.top();
      },
      ...
      return 0 === u
        ...
        : ((c = n),
          ...
          c
            ...
            .isSome()
            ? ((t = i), (a = u - 1), Tf(n, (e = r), o, e.move(t, 5), a))
      ...
      return Yf.browser.isIE()
        ...
        : i(r, t).orThunk(function() {
            return Xf(e, t, n, r, o).map(function(e) {
              var t = e.range();
              return Ll.response(
                S.some(Ul(t.start(), t.soffset(), t.finish(), t.foffset())),
                !0,
              );
            });
          });
                  ...
                  a.clear(i),
                    Zf(e.target(), u).each(function(n) {
                      pr(r, n, u).each(function(e) {
                        var t = e.boxes().getOr([]);
                        (1 < t.length || (1 === t.length && !$e.eq(r, n))) &&
                          (a.selectRange(i, t, e.start(), e.finish()),
                          o.selectContents(n));
                      });
                    });
                });
            ...
            return vr(c, f.selectedSelector()).fold(
              function() {
                return zl.isDown(u) && a
                  ? R(Jf, s, c, l, es.down, r, t, f.selectRange)
                  : zl.isUp(u) && a
                  ? R(Jf, s, c, l, es.up, r, t, f.selectRange)
                  : zl.isDown(u)
    ...
    return (
      h.on('init', function(e) {
        var r = h.getWin(),
          ...
          m = function(e) {
            var t;
            ((t = e).buttons !== undefined && 0 == (1 & t.buttons)) ||
              !as(e) ||
              n.mouseover(f(e));
          },
          g = function(e) {
