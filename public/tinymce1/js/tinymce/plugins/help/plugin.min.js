!(function() {
  ...
  var e,
    ...
    O = {
      shortcuts: [
        ...
        { shortcut: C + ' + Y or ' + C + ' + Shift + Z', action: 'Redo' },
        ...
        { shortcut: C + ' + S', action: 'Save (if save plugin activated)' },
        {
          shortcut: C + ' + F',
    ...
    H = c(function(e, o) {
      return e.replace(/\$\{([^{}]*)\}/g, function(e, t) {
        var n,
          r = o[t];
        return 'string' == (n = typeof r) || 'number' === n ? r.toString() : e;
      });
  ...
  i.add('help', function(e, t) {
    N(e, t), B(e, t), e.shortcuts.add('Alt+0', 'Open help dialog', 'mceHelp');
  });
})();
