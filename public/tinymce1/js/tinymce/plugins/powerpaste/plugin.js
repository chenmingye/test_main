  ...
  h('12', Array),
    ...
    g('g', ['12', '13'], function(a, b) {
      var c = function(a) {
        ...
        q = function(a, c, d) {
          var e = o(a, c);
          if (void 0 === e)
            throw d || 'Could not find element in array: ' + b(a);
          return e;
        },
        r = function(a, b) {
          for (var c = b || v, d = 0, e = a.length; d < e; ++d)
            if (c(a[d]) === !0) return d;
          return -1;
        },
        s = a.prototype.push,
    ...
    g('15', ['y', 'd', 's'], function(a, b, c) {
      return function(d, e) {
        var f = function() {
            return (
              b.translate('error.code.images.not.found') +
              e +
              b.translate('error.full.stop')
            );
          },
          g = function() {
            return (
              b.translate('error.imageupload') +
              e +
              b.translate('error.full.stop')
            );
          },
    ...
    g('3k', ['g', '1c', 'p', '12'], function(a, b, c, d) {
      var e = function(e, f) {
        var g = function() {
            for (var b = new d(arguments.length), f = 0; f < b.length; f++)
              b[f] = arguments[f];
    ...
    g('60', ['1b', 'g'], function(a, b) {
      var c = function(a) {
        ...
        f = function(c, d) {
          if (!a.isArray(d))
            throw 'The ' + c + ' fields must be an array. Was: ' + d + '.';
          b.each(d, function(b) {
            if (!a.isString(b))
              throw 'The value ' +
                b +
    ...
    g('3l', ['g', '1c', 'p', 'n', '60', '14'], function(a, b, c, d, e, f) {
      return function(g, h) {
        var i = g.concat(h);
        if (0 === i.length)
          throw 'You must specify at least one required or optional field.';
        return (
          ...
          function(j) {
            ...
            return (
              ...
              a.each(h, function(a) {
                n[a] = c.constant(
                  f.prototype.hasOwnProperty.call(j, a)
                    ? d.some(j[a])
                    : d.none(),
                );
              }),
    ...
    g('3s', ['62', '63', '64', '65'], function(a, b, c, d) {
      var e = function(a) {
        ...
        i = function(b, c) {
          if ((h(b, c), c !== a.abs(c)))
            throw b + ' was not an integer. Was: ' + c;
        },
        j = function(a) {
          return !c(d(a)) && b(a);
        },
        k = function(a, b) {
          if ((i(a, b), b < 0))
            throw a + ' was not a natural number. Was: ' + b;
        };
        ...
        f = function(a) {
          var d = [
              ...
              },
              {
                ...
                search: function(a) {
                  return (
                    (b(a, 'safari') || b(a, 'mobile/')) && b(a, 'applewebkit')
                  );
                },
              },
              {
    ...
    g('4n', [], function() {
      var a = function(a, b) {
        ...
        if ('object' === c) {
          var d = a.minimum;
          return (
            b.major > d.major || (b.major === d.major && b.minor >= d.minor)
          );
        }
        throw 'invalid spec';
      };
    ...
    g('2t', ['4j', '4k', '4l', '4m', '4n', '4o', '4p'], function(
      a,
      b,
      c,
      d,
    ...
    g('3f', ['1b', 'g', 'p', 'n', '2c', '3m', '3n', 'k'], function(
      a,
      b,
      c,
      d,
    ...
    g('16', ['g', '26', '27', 'k', '28', '29', '2a'], function(
      a,
      b,
      c,
      d,
    ...
    g('18', ['g', '2d', '26', '21', '22', 'j', '2a'], function(
      a,
      b,
      c,
      d,
    ...
    g('1l', ['1b', '12'], function(a, b) {
      var c = function(a, b) {
        ...
        e = function(a) {
          return function() {
            for (var c = new b(arguments.length), d = 0; d < c.length; d++)
              c[d] = arguments[d];
            ...
            f[i] = function() {
              ...
              if (a !== j.length)
                throw 'Wrong number of arguments to case ' +
                  ...
                  '), got ' +
                  a;
              for (var b = new d(a), c = 0; c < b.length; c++)
                b[c] = arguments[c];
              return {
                fold: function() {
    ...
    g('3q', ['g', '27', '3i', '12'], function(a, b, c, d) {
      var e = function(c, d) {
        ...
        j = function(a) {
          for (
            var b = a.dom().classList, c = new d(b.length), e = 0;
            e < b.length;
            e++
          )
            c[e] = b.item(e);
    ...
    g(
      '19',
      ['g', 'h', 'p', 'n', '2f', '26', '1m', '2c', 'j', '27', '2g', '20', '1f'],
      function(a, b, c, d, e, f, g, h, i, j, k, l, m) {
        var n = h.immutable('image', 'blobInfo'),
          ...
          r = function(b, d, e, g, h, i, j) {
            var l = function() {
              m.error('Internal error with blob cache', h),
                j(o.failure({ status: c.constant(666) }));
            };
                ...
                function(a, b, c, g) {
                  ...
                  return h.fold(
                    function() {
                      return [
                        e.error(
                          'Image that was just inserted could not be found: ' +
                            c,
                        ),
                      ];
                    },
    ...
    g('2j', ['1b', 'g', '3r', '2c', '37'], function(a, b, c, d, e) {
      var f = d.immutable('message', 'status', 'contents'),
        ...
        j = function(a, b, d) {
          var e = c();
          return (
            e.append(a, b, d), { data: e, contentType: !1, processData: !1 }
          );
        };
      ...
      function(a, b, c, d, e, f, g, h, i, j) {
        var k = {
          ...
          l = function(l, m, n, o) {
              ...
              a.isObject(q.headers) &&
                b.each(q.headers, function(b, c) {
                  a.isString(c) || a.isString(b)
                    ...
                    : j.error(
                        'Request header data was not a string: ',
                        c,
                        ' -> ',
                        b,
                      );
              ...
              w = function() {
                v().get(function(a) {
                  0 === r.status
                    ...
                    : n(
                        'Could not load url "' + l + '": ' + r.statusText,
                        r.status,
                        a,
                      );
                });
            ...
            (r.onerror = w),
              (r.onload = z),
              void 0 === q.data ? r.send() : r.send(q.data);
          };
        return { ajax: l };
      },
    ),
      ...
      var d = function(c, d, e, f) {
        ...
        e = function(d, e, f, g, h) {
          b.ajax(
            ...
            g,
            a.merge(
              { dataType: 'text', data: c.stringify(e), type: 'POST' },
              h,
            ),
          );
        };
    ...
    g('75', ['1l'], function(a) {
      var b = {
        ...
        c = function(a, b) {
          for (
            var c = b,
              d = c.parser[c.strictMode ? 'strict' : 'loose'].exec(a),
              e = {},
              f = 14;
            f--;
    ...
    g('2k', ['1b', '1l', '3t', '3u', '2f', '2j', '37', '3v'], function(
      a,
      b,
      c,
      d,
              ...
              q = function(b) {
                ...
                try {
                  ...
                  if (!a.isString(f.location))
                    return void m(
                      'JSON response did not contain a string location',
                      500,
                      b,
                    );
                  c = f.location;
      ...
      function(a, b, c, d, e, f, g, h, i, j, k, l) {
        var m = function(d, m) {
            ...
            var t = function(a, b, c) {
              ...
              u = function(a, b) {
                i.prepareForUpload(o, a.blobInfo().id(), a.image()).each(
                  function(c) {
                    t(c, a.blobInfo(), b);
                  },
                );
          ...
          function(b, c, d, e) {
            ...
            if (!l.get('_mcePaste')) {
              if (
                ...
                (i =
                  m != b.getDoc().body
                    ? l.getPos(b.selection.getStart(), m).y
                    : m.scrollTop),
                l.setStyles(f, {
                  position: 'absolute',
                  left: -1e4,
    ...
    g('1i', [], function() {
      var a = function(a, b) {
        ...
        for (
          ...
          a.firstChild && !g.isBlock(a.firstChild);

        )
          h.appendChild(a.firstChild);
        for (
          var i = d.createDocumentFragment();
          a.lastChild && !g.isBlock(a.lastChild);

        )
          i.appendChild(a.lastChild);
        if (
          (c.parentNode.insertBefore(h, c), g.insertAfter(i, c), a.firstChild)
        ) {
    ...
    g('6c', ['1h'], function(a) {
      var b = function(a) {
          return (
            a.specified !== !1 || ('name' === a.nodeName && '' !== a.value)
          );
        },
        c = function(a, b) {
          return a && b
      ...
      var d = 'startElement',
        ...
        m = function(a, c, j) {
          ...
          switch (a.nodeType) {
            ...
            default:
              b.log(
                'WARNING: Unsupported node type encountered: ' + a.nodeType,
              );
          }
          var q = function() {
        ...
        var f = function(b, c) {
          ...
          g = function() {
            ...
            return (
              ...
              b === a.FINISHED ||
                nextNode ||
                (c.body.removeChild(d), (nextNode = a.FINISHED)),
              f(b, g)
            );
          },
          h = function() {
    ...
    g('2o', ['3x', '3w'], function(a, b) {
      ...
      return a.createFilter(function(a, c) {
        var g = function() {
          f ||
            (a.emit(b.createStartElement('P', {}, {}, a.document)), (f = !0));
        };
        switch (c.type()) {
          case b.TEXT_TYPE:
            g(), a.emit(c);
          ...
          return (
            ...
            m
              ...
              : (b.each(c, function(a) {
                  if (a.regex.test(j)) {
                    if (g && h(a.type, g, !0))
                      return (m = a.type), (m.start = parseInt(j)), !1;
            ...
            m &&
              ...
              i &&
              ('P' !== i.tag() ||
                /^MsoHeading/.test(i.getAttribute('class'))) &&
              (m = null),
            m
          );
        },
    ...
    g('3z', ['3w', '42', '1h'], function(a, b, c) {
      var d = function(d, e) {
            ...
            for (
              f = e.openedTag.getNode(),
                ...
                f.childNodes.length > 1 &&
                  ...
                  (f = f.childNodes[1]);
              f.firstChild &&
              ('SPAN' === f.firstChild.tagName || 'A' === f.firstChild.tagName);

            )
              (f = f.firstChild), j(f);
            if (((f = f.firstChild), !f || 3 !== f.nodeType))
              return f && 'IMG' === f.tagName;
            if (
              ((g = f.value),
              c.trim(g) ||
                ((f = f.parentNode.nextSibling), (g = f ? f.value : '')),
        ...
        e = function(a, b) {
          ...
          for (
            c = a.parentNode;
            null !== c && void 0 !== c && c !== b.parentNode;
        ...
        f = function(a) {
          ...
          return function(c, d) {
            var e,
              f = c + ',' + d;
            return b.hasOwnProperty(f)
              ? b[f]
              : ((e = a.call(null, c, d)), (b[f] = e), e);
          };
        },
        g = function(a) {
          var b = a.indexOf('.');
          if (b >= 0 && c.trim(a.substring(b + 1)) === className)
            return (match = results[2]), !1;
        },
        h = f(function(a, b) {
          var d,
            e,
    ...
    g('40', ['3w', '42'], function(a, b) {
      var c = ['disc', 'circle', 'square'],
        d = function(a, b) {
          return (
            'UL' === a.tag && c[b - 1] === a.type && (a = { tag: 'UL' }), a
          );
        };
      return function(c, e) {
        var f,
          ...
          k = function() {
            c.emit(a.createEndElement(g.pop().tag, e)),
              i--,
              (f = g[g.length - 1]);
          },
          l = function() {
          ...
          m = function() {
            var b = h ? h.pop() : 'P';
            'P' != b && c.emit(a.createEndElement(b, e)),
              c.emit(a.createEndElement('LI', e));
          },
          n = function(d, g, i) {
            var l = {};
            if (d) {
            ...
            if (g) {
              ...
              if (((g = d(g, b)), i == b)) m(), n(f, g, l);
                ...
                for (
                  ...
                  h.length > 0 &&
                  'P' !== h[h.length - 1] &&
                  (c.emit(a.createEndElement(h[h.length - 1], e)),
                  (h[h.length - 1] = 'P'));
                  i < b;
    ...
    g('41', ['3y', '3w', '3z', '42', '1h'], function(a, b, c, d, e) {
      var f = function(a, b) {
          e.log('Unexpected token in list conversion: ' + b.toString()),
            a.rollback();
        },
        g = function(a, b, c) {
          return b == c ? a : null;
        ...
        j = function(d, e, f) {
          ...
          if (
            ...
            var h =
              (f.getStyle('mso-list'),
              / level([0-9]+)/.exec(f.getStyle('mso-list')));
            h && h[1]
            ...
            ((f.type() === b.COMMENT_TYPE &&
              '[if !supportLists]' === f.text()) ||
        ...
        m = function(c, d, e) {
          e.type() === b.TEXT_TYPE
            ? e.isWhitespace() ||
              ((d.nextFilter = n),
              (d.bulletInfo = { text: e.text(), symbolFont: d.symbolFont }))
            : a.spanOrA(e)
            ...
            ? ((d.nextFilter = n),
              (d.bulletInfo = { text: '\u2202', symbolFont: !0 }))
            : f(c, e);
        },
        n = function(c, d, e) {
          ...
          var j = function(a) {
            if (
              ...
              (h.listType = d.guessListType(
                h.bulletInfo,
                g(
                  h.emitter.getCurrentListType(),
                  h.emitter.getCurrentLevel(),
                  h.itemLevel,
                ),
                h.originalToken,
              )),
    ...
    g('2p', ['3x', '3y', '3w', '3z', '40', '41', '42', '1h'], function(
      a,
      b,
      c,
      d,
      ...
      var k = function(a) {
        ...
        l = function(a, b) {
          i.styles.check(b) ||
            ((i.symbolFont = g.checkFont(b, i.symbolFont)),
            i.nextFilter(a, i, b));
        };
    ...
    g('2q', ['1h'], function(a) {
      var b = function(a) {
        ...
        g = [b],
        h =
          tinymce.isIE && document.documentMode >= 9
            ? [f, e, d, c].concat(g)
            : g,
        i = a.compose(h);
        ...
        a.seenList
          ...
          : ('OL' === c.tag() || 'UL' === c.tag()
              ...
              : 'LI' === c.tag() &&
                ((a.inferring = 1),
                a.needsClosing ||
                  a.emit(b.createStartElement('UL', {}, {}, a.document))),
            !a.needsClosing ||
              a.inferring ||
              c.isWhitespace() ||
              ((a.needsClosing = !1),
              a.emit(b.createEndElement('UL', a.document))),
            a.emit(c));
      });
    }),
    g('45', ['3x'], function(a) {
    ...
    g('47', ['3x', '3y', '3w'], function(a, b, c) {
      var d = [],
        ...
        g = function(a, b) {
          ...
          for (e = b + 1; e < a; e++)
            if (((f = d[e]), f && 'SPAN' === f.tag()))
              ...
              else if (f.type() === c.END_ELEMENT_TYPE && (g--, 0 === g))
                return void (d[e] = null);
        },
        h = function(a) {
          if (f) {
            var h,
        ...
        i = function(a, b) {
          if ((d.push(b), (e = e || []), b.type() === c.START_ELEMENT_TYPE))
            e.push(b);
      ...
      return a.createFilter(function(a, e) {
        ...
        var h = function(a) {
          return !(
            g.indexOf(',' + a.tag() + ',') >= 0 && b.hasNoAttributes(a, !0)
          );
        };
        0 === d.length
    ...
    g('4a', ['3x', '3w'], function(a, b) {
      return a.createFilter(function(a, c) {
        if ('IMG' === c.tag()) {
          if (c.type() === b.END_ELEMENT_TYPE && a.skipEnd)
            return void (a.skipEnd = !1);
          if (c.type() === b.START_ELEMENT_TYPE) {
            if (/^file:/.test(c.getAttribute('src')))
    ...
    g('4c', ['3x', '3y', '3w'], function(a, b, c) {
      var d = function(a) {
          return (
            !b.hasNoAttributes(a) && !/^OLE_LINK/.test(a.getAttribute('name'))
          );
        },
        e = [];
      return a.createFilter(function(a, b) {
    ...
    g('4h', ['3x'], function(a) {
      return a.createAttributeFilter(function(a, b) {
        return 'href' === a &&
          (b.indexOf('#_Toc') >= 0 || b.indexOf('#_mso') >= 0)
          ? null
          : b;
      });
    }),
    ...
    g('1k', ['2m', '2n', '2o', '2p', '2q', '2r', '2s'], function(
      a,
      b,
      c,
      d,
      ...
      var h = function(a, b, c, d) {
        ...
        i = function(c, d, e, f) {
          var g = a.create(e),
            i = b.tokenize(c, e);
          for (pipeline = h(f, g, d, e); i.hasNext(); )
            pipeline.receive(i.next());
          return g.dom;
        },
        j = function(a, b, c) {
          var d = e.all(a),
    ...
    g('1n', ['g', '1s', '2t', 'h', 'o', '2u', '2b', 'j'], function(
      a,
      b,
      c,
      d,
        ...
        var o = function(a) {
          ...
          u = function(a) {
            c.multiple(a).get(function(a) {
              var b = t(a);
              i.insertContent(b, {
                merge: i.settings.paste_merge_formats !== !1,
              }),
                l.uploadImages(a);
            });
          };
        i.on('drop', function(a) {
          if (!m) {
            ...
            if (q(d)) {
              ...
              e.showDialog(d['text/html'] || d['text/plain']),
                a.preventDefault();
            }
          }
        });
    ...
    g('2v', ['4q', '4r', '2w', 'g', 'p', '23', '2c'], function(
      a,
      b,
      c,
      d,
    ...
    g('1o', ['2v', '2w', 'g', 'p', '2x', '21', '22', '2y'], function(
      a,
      b,
      c,
      d,
    ...
    g('6d', ['4x', '78', '79', '7a', 'n', '2f', '37', '12', '62'], function(
      ...
      var j = function(a, e) {
        ...
        k = function(a) {
          return (
            g.startsWith(a, 'data:image/') &&
            a.indexOf(';base64,') > 'data:image/'.length
          );
        },
        l = function(b) {
    ...
    g('7r', ['2t', 'p', 'k', '1g'], function(a, b, c, d) {
      var e = function(a) {
          for (var b = []; null !== a.nextNode(); )
            b.push(c.fromDom(a.currentNode));
          return b;
        },
        f = function(a) {
          try {
    ...
    g('6r', ['1b', 'g', 'p', 'n', '5i', '3n', 'k', '2i'], function(
      a,
      b,
      c,
      d,
    ...
    g('6e', ['7b', 'g', '5a', 'n', '23', '2c', 'j', '28', '2a', '1f'], function(
      ...
      var k = f.immutable('img', 'vshape'),
        ...
        p = function(a, c) {
          ...
          return (
            f.isNone() &&
              j.log('WARNING: unable to find data for image', a.dom()),
            f.map(function(b) {
              return q(a, b);
            })
          );
      ...
      return function(d, e) {
        var f = function(a) {
          ...
          k = function(a, b) {
            if (!d(a))
              throw new c(
                'Can only set raw ' + e + ' value of a ' + e + ' node',
              );
            a.dom().nodeValue = b;
          };
    ...
    g('7e', ['j', 'k', '1x', '20', '7t', '7u', '12'], function(
      a,
      b,
      c,
      d,
    ...
    (function(a, b, c) {
      ...
      f.bolt.module.api.define,
      f.bolt.module.api.require,
      f.bolt.module.api.demand,
    ),
    g(
      '6f',
      [
    ...
    g('71', ['n', 'k'], function(a, b) {
      var c = function(c) {
          ...
          try {
            ...
            return (
              console.log('Error reading iframe: ', d),
              console.log('Error was: ' + f),
              a.none()
            );
          }
        },
    ...
    g('25', ['p', 'k'], function(a, b) {
      var c = function(b, c, d, e, f, g, h) {
        ...
        e = function(b, c, e, f, g) {
          var i = d(e, f);
          return (
            b.dom().addEventListener(c, i, g),
            { unbind: a.curry(h, b, c, i, g) }
          );
        },
        f = function(a, b, c, d) {
          return e(a, b, c, d, !1);
    ...
    g('6g', ['p', '5x', '5d', 'w', 'k', '1x', '1y', 'x'], function(
      a,
      b,
      c,
      d,
    ...
    g(
      '51',
      ['4q', '4r', '6e', '6f', '2w', 'p', '6g', 'k', '28', '6h', '1g'],
      function(a, b, c, d, e, f, g, h, i, j, k) {
        var l = 'data-textbox-image',
          ...
          o = function(a, b) {
            ...
            return function(e, g) {
              c.play(
                ...
                function(c, e) {
                  return (
                    d.process(c, e, a, l, { mergeInline: f.constant(b) }),
                    j.get(e)
                  );
                },
                g,
          ...
          s = function(b, c, d) {
            ...
            return d.cleanDocument(g, c).fold(
              function() {
                return a.pure({
                  response: e.error('errors.paste.word.notready'),
                  bundle: {},
                });
              },
              function(a) {
    ...
    g('7i', ['g', '1l', '7x', '7y', 'p', 'j', '27', '3q', '1y', '2a'], function(
      ...
      var k = function(b, d, e) {
        ...
        l = function(l, m) {
          var n = b.merge(
              { styles: [], attributes: [], classes: [], tags: [] },
              m,
            ),
            o = j.descendants(l, '*');
          a.each(o, function(b) {
    ...
    g('7j', ['7z', '80'], function(a, b) {
      var c = function(a, b, c) {
        ...
        d = function(d, e, f) {
          for (
            var g = a.create(d), h = b.tokenise(e, d), i = c(d, f, g);
            h.hasNext();
    ...
    g('6m', ['g', '7i', '7j', 'k', '6h', '1y', '3f'], function(
      a,
      b,
      c,
      d,
    ...
    g('8t', ['g', '8u', '96', '8l', 'p', '2c', 'j', 'k'], function(
      a,
      b,
      c,
      d,
      ...
      var i = function(a, b) {
        ...
        l = function(c) {
          return (
            !a.contains(['P'], c.tag()) ||
            /^MsoHeading/.test(b.getAttribute(c, 'class'))
          );
        },
        m = function(a, b, d, e) {
        ...
        n = function(a, b, c) {
          ...
          return (
            d.each(c.listType.set),
            k(b.level(), c.originalToken.get(), c.listType.get())
          );
        },
        o = function(a) {
          return function(b, c, e) {
            ...
            var g = n(e, f, c);
            c.emitter.openItem(g.level(), g.token(), g.type()),
              d.next(c, a.inside());
          };
        };
    ...
    g('8i', ['8t', '86', '8u', '8v', '8w', '8l'], function(a, b, c, d, e, f) {
      var g = function(a) {
          ...
          return e('Inside.List.Item', [d(g, c, 'Closing open tag')], function(
            a,
            b,
            c,
          ) {
    ...
    g('9l', ['7y', '86', '96', '97', '9j', '9v', 'p'], function(
      a,
      b,
      c,
      d,
    ...
    g('98', ['g', '86', '97', '9j', '9k', '9l', 'p', 'n'], function(
      a,
      b,
      c,
      d,
    ...
    g('8x', ['g', '97', '98'], function(a, b, c) {
      var d = ['disc', 'circle', 'square'],
        e = function(a, b) {
          return (
            'UL' === a.tag && d[b - 1] === a.type && (a = { tag: 'UL' }), a
          );
        };
      return function(d, f) {
          ...
          var j = g[c] ? [g[c]] : [],
            ...
            l = a.bind(e, function(a) {
              return a.regex.test(c)
                ? [b.merge(a.type, i(c), { variant: h(a.type, c) })]
                : [];
            }),
        ...
        var o = 18,
          ...
          u = function(a) {
            return i.descendant(a, function(a) {
              var b = h.isElement(a)
                ? c.scan(a, ['mso-list'], d.constant(!1))
                : [];
              return !!b['mso-list'];
            });
          },
    ...
    g(
      '7h',
      ['7w', '6m', '7k', '84', '85', 'p', '27', '5d', '3f', '1d', '83'],
      function(a, b, c, d, e, f, g, h, i, j, k) {
        var l = b.unwrapper({
            tags: [{ name: k.pattern(/^([OVWXP]|U[0-9]+|ST[0-9]+):/i) }],
          }),
          ...
          o = b.removal({
            attributes: [{ name: k.exact('id') }, { name: k.exact('name') }],
          }),
          p = b.removal({
            tags: [
              { name: k.exact('script') },
          ...
          t = b.removal({
            classes: [{ name: k.not(k.exact('rtf-data-image')) }],
          }),
          ...
          x = b.unwrapper({
            tags: [{ name: k.exact('a'), condition: d.hasNoAttributes }],
          }),
          y = b.removal({
            attributes: [
              { name: k.exact('style'), value: k.exact(''), debug: !0 },
            ],
          }),
          z = b.removal({
            attributes: [
              { name: k.exact('class'), value: k.exact(''), debug: !0 },
            ],
          }),
          A = b.unwrapper({
            tags: [
              {
                name: k.pattern(a.specialInline()),
                condition: f.not(d.hasContent),
              },
            ],
          }),
          B = b.unwrapper({
            tags: [{ name: k.exact('p'), condition: r('li') }],
          }),
          C = b.transformer({
            tags: [{ name: k.exact('p'), mutate: e.addBrTag }],
          }),
          D = function(a) {
            var b = e.changeTag('span', a);
            g.add(b, 'ephox-limbo-transform'),
              h.set(b, 'text-decoration', 'underline');
          },
          E = b.transformer({
            tags: [{ name: k.pattern(/ol|ul/), mutate: e.properlyNest }],
          }),
          F = b.transformer({
            tags: [
          ...
          G = b.removal({
            classes: [{ name: k.exact('ephox-limbo-transform') }],
          }),
          H = b.removal({
            attributes: [
              { name: k.exact('href'), value: k.starts('file:///'), debug: !0 },
            ],
          });
        return {
          unwrapWordTags: l,
    ...
    g('6k', ['g', '5a', '7h', '6m', '7k', '7l', 'p', 'k'], function(
      a,
      b,
      c,
      d,
      ...
      var i = function(a) {
        ...
        k = function(a, e, f) {
          var g =
              f.browser.isFirefox() || f.browser.isSpartan()
                ? b.local
                : b.vshape,
        ...
        return function() {
          var r = function(a) {
            ...
            s = function(c) {
              return (
                !!j.isElement(c) &&
                ('body' === j.name(c) || b.contains(a, j.name(c)))
              );
            },
            t = function(a) {
              return (
                !!j.isElement(a) && b.contains(['br', 'img', 'hr'], j.name(a))
              );
            },
            u = function(a, b) {
    ...
    g('9c', ['g', 'n', '90', '94', '9u'], function(a, b, c, d, e) {
      var f = function(f, g, h) {
        ...
        return (
          f.insert().afterAll(g, l), [c.range(g, 0, j[0].length)].concat(k)
        );
      };
      return { subdivide: f };
    }),
    ...
    g('89', ['8s', 'p'], function(a, b) {
      ...
      return {
        chars: b.constant(c),
        wordbreak: b.constant(d),
        wordchar: b.constant(e),
      };
    }),
    g('8a', ['4v'], function(a) {
          ...
          u = function(a) {
            return b
              ...
              .map(function(b) {
                var c = h.fromTag('a');
                return (
                  i.before(b, c), j.append(c, a), f.set(c, 'href', m.get(c)), c
                );
              });
          },
          v = function(b) {
        ...
        h = function(g, h, i) {
          var j = !1,
            ...
            l = function(a, b) {
              return void 0 === h || b
                ? d.none()
                : h.findClipboardTags(f.children(a));
            },
            m = l(i, j).getOr([]);
          b.each(m, e.remove);
    ...
    g('57', ['6m', 'j', '6h', '6n'], function(a, b, c, d) {
      var e = function(a, c) {
          return d.descendant(a, function(a) {
            return (
              !!b.has(a, 'style') && b.get(a, 'style').indexOf('mso-') > -1
            );
          });
        },
        f = function(b, d) {
    ...
    g('35', ['4q', '4r', '56', '2t', '57', '27', '3f'], function(
      a,
      b,
      c,
      d,
    ...
    g('6p', ['6o', '4y', 'g', 'i', 'n', 'j', '27', '1f'], function(
      a,
      b,
      c,
      d,
    ...
    g('58', ['59', 'g', '5a', '21', '22', '1y', '3f'], function(
      a,
      b,
      c,
      d,
                  ...
                  o = function(a, c, o) {
                    ...
                    l.append(u, a),
                      b.rtf().fold(
                        ...
                        function(a) {
                          if (p.allowLocalImages === !0)
                            r.processRtf(u, c, o, a, h.noop);
                          else {
                            var b = g.find(u),
                              d = n.children(u);
                            b.length > 0
      ...
      function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
        var o = l.immutable('data', 'rtf'),
          ...
          B = function(a) {
            ...
            return 1 === d.length && 'text/plain' === d[0]
              ? k.some(b)
              : k.none();
          },
          C = function(a) {
          ...
          H = function(b) {
            return D(
              ...
              [
                a.normal(
                  b.allowLocalImages === !1 ? f.noImages(j.noop) : f.images(),
                ),
              ],
              !0,
            );
          ...
          K = function() {
            return D(
              'There is no valid way to paste',
              k.some,
              [a.normal(f.none)],
              !1,
            );
    ...
    g('5b', ['5c', '2t', 'j', '27', 'k', '6h', '29'], function(
      a,
      b,
      c,
      d,
      ...
      var h = function() {
        ...
        i = function(a) {
          return e.fromHtml(
            '<p>' + a('cement.dialog.flash.press-escape') + '</p>',
          );
        },
        j = function(b) {
          var c = e.fromTag('div');
          ...
          var f = h(),
            j = e.fromHtml(
              '<p>' + b('cement.dialog.flash.trigger-paste') + '</p>',
            ),
            k = e.fromHtml(
          ...
          return (
            d.add(k, a.resolve('flashbin-helpcopy-kbd')),
            g.append(c, [j, k, i(b)]),
            c
          );
        },
      ...
      function(a, b, c, d, e, f, g, h, i, j) {
        var k = c.detect(),
          ...
          o = function(b, c, d, e) {
            ...
            return (
              c.events.spin.bind(l),
              c.events.reset.bind(k),
              c.events.hide.bind(j),
              { reset: k }
            );
          };
    ...
    g('6t', ['72'], function(a) {
      var b = function(a, b) {
        ...
        c = function(c, d) {
          for (var e = d || a, f = c.split('.'), g = 0; g < f.length; ++g)
            e = b(e, f[g]);
          return e;
        };
      return { namespace: c };
    ...
    g('5j', ['p', 'n', '3n', 'k', '6n', '3f', '1g'], function(
      a,
      b,
      c,
      d,
        ...
        return function(g) {
          ...
          var C = function(a) {
              v.stop(),
                w(function() {
                  '' === a
                    ? h.trigger.error('flash.crashed')
                    : h.trigger.response(x(a));
                }, 0);
            },
            D = function() {
              if ((N.stop(), !j)) {
                ...
                try {
                  ...
                  e.each(J, function(b, c) {
                    var d = a[c];
                    if (void 0 === d)
                      throw 'Flash object does not have the method "' + c + '"';
                    d.call(a, b);
                  }),
                    h.trigger.reset(),
                    S(),
          ...
          var O = function() {
            ...
            P = function() {
              A.browser.isFirefox() && y.getSelection().removeAllRanges(),
                q.focus(L);
            },
            Q = null,
            R = function() {
    ...
    g('1q', ['38', '39', '21', '22', 'w', 'k', '11'], function(
      a,
      b,
      c,
      d,
      ...
      return function(h, i) {
        var j = i.translations,
          ...
          l = function() {
            ...
            p.reset(),
              o.setContent(p.element()),
              o.events.close.bind(n),
              o.show(),
              c.activate();
            var q = function() {
        ...
        l = function(a, c) {
          ...
          return d.fold(
            ...
            function(a) {
              return b
                .write()
                .flip(a.start(), a.soffset(), a.finish(), a.foffset());
            },
          );
        },
        m = function(a) {
    ...
    g('5t', ['5o', '6u', '5s', '6w', 'n', 'k', '6x'], function(
      a,
      b,
      c,
      d,
      ...
      var h = function(a) {
        ...
        k = function(c, d) {
          ...
          return b.read().isRtl(c)
            ? b.read().flip(c, d)
            : a.read(e, d.startOffset, g, d.endOffset);
        },
        l = function(a, b) {
          return void 0 !== b && null !== b && b.rangeCount > 0
            ? e.from(j(a, b))
            : e.none();
        },
        m = function(a, b) {
    ...
    g('3a', ['5o', '5p', '5q', '5r', '5s', '5t', '3n', 'k'], function(
      a,
      b,
      c,
      d,
    ...
    g('3d', ['p', '2x', '21', '22', '2y', '5v', '3f'], function(
      a,
      b,
      c,
      d,
    ...
    g('1r', ['2t', '3a', '21', '22', '3b', '3c', '3d', '1d'], function(
      a,
      b,
      c,
      d,
    ...
    g('r', ['j', 'k', '1x', '1y', '1z', '20', '1g'], function(
      a,
      b,
      c,
      d,
    ...
    g('t', ['21', '22', 'v', 'j', 'k', '1x', '1y', '20'], function(
      a,
      b,
      c,
      d,
      ...
      var e = function(a) {
        ...
        i = function(a, c) {
          return d.parseUrlFromLinkHtml(c).bind(function(c) {
            var e =
              a.selection.isCollapsed() === !1 && d.isAbsoluteUrl(c.url());
        ...
        return function(s, t, u, v, w) {
          ...
          s.on('init', function(d) {
            ...
            var l = {
                ...
                swf: y,
                officeStyles:
                  s.settings.powerpaste_word_import || h.officeStyles,
                htmlStyles: s.settings.powerpaste_html_import || h.htmlStyles,
                translations: g.translate,
                allowLocalImages:
                  s.settings.powerpaste_allow_local_images !== !1,
                enableFlashImport:
                  s.settings.powerpaste_enable_flash_import !== !1,
                ...
                a.events.cancel.bind(function() {
                  ...
                  a.events.insert.bind(function(a) {
                    ...
                    s.focus(),
                      q(function() {
                        F(),
                          E(s, m.process(s, b), a.assets()),
                          w.uploadImages(a.assets());
                      }, 1);
                  });
              },
    ...
    g('7', ['y', 'z'], function(a, b) {
      var c = function(a) {
        return (
          tinymce.util.VK.metaKeyPressed(a) && 86 == a.keyCode && a.shiftKey
        );
      };
      return function(d) {
    ...
    g('1', ['3', '4', '5', '6', '7', '8', '9', 'a', '2'], function(
      a,
      b,
      c,
      d,
      ...
      return function(j) {
        return g.isLessThan(i, '4.0.0')
          ? (h.error(
              'The "powerpaste" plugin requires at least 4.0.0 version of TinyMCE.',
            ),
            function() {})
          : function(g, h) {
              var k = e(g),
                l = function() {
                  var b = a(g);
                  d(g, k, h, j, b),
                    g.settings.powerpaste_block_drop || c(g, h, j, b);
                },
                m = function() {
                  b(g, k, j);
                },
