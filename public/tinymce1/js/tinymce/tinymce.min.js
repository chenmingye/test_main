...
!(function() {
  ...
  (Pt.prototype = ge.filters = ge.pseudos),
    ...
    (ye = Tt.select = function(e, t, n, r) {
      ...
      return (
        (c || be(e, l))(r, t, !Te, n, (wt.test(e) && Ot(t.parentNode)) || t), n
      );
    }),
    (me.sortStable =
      $e
  ...
  (pn.fn = pn.prototype = {
    ...
    remove: function() {
      for (var e, t = this.length; t--; )
        (e = this[t]), en.clean(e), e.parentNode && e.parentNode.removeChild(e);
      return this;
    },
    empty: function() {
      for (var e, t = this.length; t--; )
          ...
          (l = e) && l.hasEventListeners('PreProcess') && !f.no_events
            ? ((o = t),
              ...
              (a = document.implementation).createHTMLDocument &&
                ...
                Yt.each('BODY' === o.nodeName ? o.childNodes : [o], function(
                  e,
                ) {
